...
THOST_FTDC_BFC_QryCoverLack = 'Y'
THOST_FTDC_BFC_UnCombTest = 'Z'
THOST_FTDC_BFC_InternalTransfer = 'I'
...
THOST_FTDC_IPT_Unknown = '0'
THOST_FTDC_IPT_NotProgramming = '1'
THOST_FTDC_IPT_Programming = '2'
THOST_FTDC_TC_IOC = '1'
THOST_FTDC_TC_GFS = '2'
THOST_FTDC_TC_GFD = '3'
THOST_FTDC_TC_GTD = '4'
...
THOST_FTDC_IS_Auction = '7'
THOST_FTDC_IS_BusinessSuspension = '8'
THOST_FTDC_IS_VolatilityInterrupt = '9'
THOST_FTDC_IS_TemporarySuspension = 'a'
THOST_FTDC_IS_AuctionAfterClosed = 'b'
THOST_FTDC_IS_ResumableFusing = 'c'
THOST_FTDC_IS_UnResumableFusing = 'd'
THOST_FTDC_IS_TradingAfterClosed = 'e'
...
THOST_FTDC_TPID_IsOrderTypeLimit = 'D'
...
THOST_FTDC_TPID_IsLinearMargin = 'X'
...
THOST_FTDC_BC_BankFu = '0'
THOST_FTDC_BC_BankSe = '1'
THOST_FTDC_RN_CD = '0'
THOST_FTDC_RN_ZT = '1'
THOST_FTDC_RN_QT = '2'
...
THOST_FTDC_OOD_ReserveOpen = '2'
THOST_FTDC_OOD_ForceClose = '5'
...
THOST_FTDC_OS_CheckFileReady = '6'
THOST_FTDC_OS_TotalFileArrived = '7'
THOST_FTDC_OS_SecurityFileSent = '8'
...
THOST_FTDC_FBTUET_ReserveOpenAccountConfirm = 'D'
THOST_FTDC_FBTUET_SecuritiesDepositInterest = 'E'
THOST_FTDC_FBTUET_DayEndFileReady = 'F'
THOST_FTDC_FBTUET_CancelReserveOpenAccount = 'G'
...
THOST_FTDC_ORPT_OptLastPriceWithSecLastPrice = '6'
THOST_FTDC_ORPT_MaxPreSettlementWithLastPrice = '7'
THOST_FTDC_ORPT_MaxPreSettlementWithMaxLastPrice = '9'
...
THOST_FTDC_LCKT_Lock = '1'
THOST_FTDC_LCKT_Unlock = '2'
THOST_FTDC_BZTP_Future = '1'
THOST_FTDC_BZTP_Stock = '2'
THOST_FTDC_DSTP_Register = '1'
THOST_FTDC_DSTP_Cancel = '2'
THOST_FTDC_FRTP_Init = '1'
THOST_FTDC_FRTP_Lock = '2'
THOST_FTDC_FRTP_Exec = '3'
THOST_FTDC_FRTP_Check = '4'
THOST_FTDC_FRTP_ExecFreeze = '5'
THOST_FTDC_FZTP_Freeze = '1'
THOST_FTDC_FZTP_Unfreeze = '2'
THOST_FTDC_FZTP_Force = '3'
THOST_FTDC_TSTP_Unknow = '0'
THOST_FTDC_TSTP_Future = '1'
THOST_FTDC_TSTP_IShare = '2'
THOST_FTDC_STPT_ToBroker = '1'
THOST_FTDC_STPT_ToInvestor = '2'
THOST_FTDC_SDPS_Submitted = 'a'
THOST_FTDC_SDPS_Accepted = 'b'
THOST_FTDC_SDPS_Rejected = 'c'
THOST_FTDC_SDPS_Cancelled = 'd'
THOST_FTDC_ISTR_Limit = '1'
THOST_FTDC_ISTR_Limit_FOK = '2'
THOST_FTDC_ISTR_Market_RemainLimit = '3'
THOST_FTDC_ISTR_Market_FAK = '4'
THOST_FTDC_ISTR_Market_FOK = '5'
THOST_FTDC_ISTR_Lock = '6'
THOST_FTDC_ISTR_Unlock = '7'
THOST_FTDC_IVLV_FirstLevel = '1'
THOST_FTDC_IVLV_SecondLevel = '2'
THOST_FTDC_IVLV_ThirdLevel = '3'
THOST_FTDC_STOV_RealValue = '1'
THOST_FTDC_STOV_ProfitValue = '2'
THOST_FTDC_STOV_RealRatio = '3'
THOST_FTDC_STOV_ProfitRatio = '4'
THOST_FTDC_SSCS_NotSend = '0'
THOST_FTDC_SSCS_SendSuccess = '1'
THOST_FTDC_SSCS_SendFail = '2'
...
THOST_FTDC_SITP_Unsettled = '0'
THOST_FTDC_SITP_Batch = '1'
THOST_FTDC_SITP_CancelAccount = '2'
THOST_FTDC_SITP_Other = '3'
THOST_FTDC_ISU_UnSuccess = '0'
THOST_FTDC_ISU_Success = '1'
THOST_FTDC_SFSPTYPE_Broker = '0'
THOST_FTDC_SFSPTYPE_Bank = '1'
THOST_FTDC_SFFBTTD_FromBankToFuture = '1'
THOST_FTDC_SFFBTTD_FromFutureToBank = '2'
THOST_FTDC_SFCRF_Cash = '0'
THOST_FTDC_SFCRF_Remit = '1'
THOST_FTDC_SFSTS_Normal = '0'
THOST_FTDC_SFSTS_Cancel = '1'
THOST_FTDC_SFBSF_Sell = '0'
THOST_FTDC_SFBSF_Buy = '1'
THOST_FTDC_SFICT_IDCard = '0'
THOST_FTDC_SFICT_Passport = '1'
THOST_FTDC_SFICT_LicenseNo = '2'
THOST_FTDC_SFICT_OfficerIDCard = '3'
THOST_FTDC_SFICT_SoldierIDCard = '4'
THOST_FTDC_SFICT_HMTMainlandTravelPermit = '5'
THOST_FTDC_SFICT_TmpIDCard = '6'
THOST_FTDC_SFICT_HouseholdRegister = '7'
THOST_FTDC_SFICT_PoliceIDCard = '8'
THOST_FTDC_SFICT_EID = '9'
THOST_FTDC_SFICT_Government = 'A'
THOST_FTDC_SFICT_SocialOrg = 'B'
THOST_FTDC_SFICT_Army = 'C'
THOST_FTDC_SFICT_ArmedPolice = 'D'
THOST_FTDC_SFICT_SubOrganization = 'E'
THOST_FTDC_SFICT_PermanantResidence = 'F'
THOST_FTDC_SFICT_BorderEntryPermit = 'G'
THOST_FTDC_SFMKID_SH = '0'
THOST_FTDC_SFMKID_SZ = '1'
THOST_FTDC_INTERFDDIREC_FundIn = '0'
THOST_FTDC_INTERFDDIREC_FundOut = '1'
THOST_FTDC_INTERFDSTATUS_UnSend = '0'
THOST_FTDC_INTERFDSTATUS_Sent = '1'
THOST_FTDC_INTERFDSTATUS_Reject = '2'
THOST_FTDC_INTERFDSTATUS_OverTime = '3'
THOST_FTDC_INTERFDSTATUS_Success = '4'
THOST_FTDC_INTERFDSTATUS_IsCharged = '5'
THOST_FTDC_FUNDSERVERSTATUS_NotConnected = '0'
THOST_FTDC_FUNDSERVERSTATUS_Connected = '1'
THOST_FTDC_FUNDSERVERSTATUS_Login = '2'
THOST_FTDC_FUNDSERVERSTATUS_OverTime = '3'
THOST_FTDC_FUNDREDOFLAG_NotRedo = '0'
THOST_FTDC_FUNDREDOFLAG_Redo = '1'
THOST_FTDC_FUNDSTATUS_OutSuccess = '0'
THOST_FTDC_FUNDSTATUS_OutFail = '1'
THOST_FTDC_FUNDSTATUS_OutOverTime = '2'
THOST_FTDC_FUNDSTATUS_OutCharged = '3'
THOST_FTDC_FUNDSTATUS_InSuccess = '4'
THOST_FTDC_FUNDSTATUS_InFail = '5'
THOST_FTDC_FUNDSTATUS_InOverTime = '6'
THOST_FTDC_FUNDSTATUS_InCharged = '7'
THOST_FTDC_FUNDSTATUS_ChargedFail = '8'
THOST_FTDC_FUNDSTATUS_Submitted = '9'
THOST_FTDC_LMT_Base = '1'
THOST_FTDC_LMT_Normal = '2'
THOST_FTDC_LMT_Comb = '3'
